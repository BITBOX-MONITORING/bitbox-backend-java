...
//              conDocker.update(String.format("insert into Registro (data_registro,cpu_uso,ram_uso,ram_disponivel,rede_download,rede_upload,disco_tempo_resposta,disco_capacidade_disponivel,fk_componente,fk_maquina,fk_tipo_componente,fk_funcionario) values('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')",
//                      formatoAmericano,registro.getUsoCPU(),registro.getMemoriaEmUsoGB(),registro.getMemoriaDisponivelGB(),registro.showDownload(),registro.showUpload(), registro.showUsado(), registro.showTotal(),4,1,1,1));
